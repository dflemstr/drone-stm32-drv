...
impl<T: DmamuxRgMap> DmamuxRg<T> {
    ...
    #[inline]
    pub fn as_enabled(&self, _token: &InventoryToken<DmamuxEn<T::DmamuxMap>>) -> &DmamuxRgEn<T> {
        &self.0
    }
    ...
    #[inline]
    pub fn into_enabled(self, token: InventoryToken<DmamuxEn<T::DmamuxMap>>) -> DmamuxRgEn<T> {
...
impl<T: DmamuxRgMap> DmamuxRgEn<T> {
    ...
    #[inline]
    pub fn into_disabled(self) -> (DmamuxRg<T>, InventoryToken<DmamuxEn<T::DmamuxMap>>) {
